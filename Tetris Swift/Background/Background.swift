...
class BackGround {
    ...
    func lines() {
        ...
        leftLine.position = CGPoint(x: leftX, y: -topY+30)
        ...
        rightLine.position = CGPoint(x: rightX, y: -topY+30)
        ...
        bottomLine.position = CGPoint(x: leftX, y: -bottomY+30)
        ...
        topLine.position = CGPoint(x: leftX, y: -topY+30)
